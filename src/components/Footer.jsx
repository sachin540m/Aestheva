        ...
        <div className="footer-top">
          <div className="footer-brand">
            <div className="footer-logo">
              <img src="/minilogo.jpg" alt="Dr. Ketaki's Aesthéva Logo" title="Dr. Ketaki's Aesthéva" loading="lazy" decoding="async" width="50" height="50" style={{ height: '50px', width: 'auto' }} />
            </div>
